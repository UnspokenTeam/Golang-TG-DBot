...
Для владельца (недоступно обычным пользователям) :
  ...
  /admin_stats - Приватная статистика за последние сутки. Команда также доступна админам.
  ...
  /analyze - Получить ссылку на логи по конкретному пользователю и чаты в Uptrace. Команда также доступна админам. __(применяется в ответ на сообщение)__
